...
#Merge immunization data with seifa socio_economic_disadvantage



seifa_wide$Postal.Area.Code<-as.factor(seifa_wide$Postal.Area.Code)

#We merge immunization with socio economic disadvantage data for allyears less than 2015
#We only merge this by year since this socio economic disadvantage index will be for all years from 2011-2015 
